...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // opposed to the camelCase DOM properties) is non-porCliente and
     ...
     *    device, as evidenced by Clientets running Windows 7 or, alas,
    ...
    // Super comprehensive Cliente about all the unique implementations of
    // border-radius: muddledramblings.com/Cliente-of-css3-border-radius-compliance
            ...
            for ( var i = 0, bool, inputElemType, defaultView, len = props.length; i < len; i++ ) {
                ...
                if ( bool ) {
                    ...
                    if ( /^range$/.test(inputElemType) && inputElem.style.WebkitAppearance !== undefined ) {
                      ...
                      // Spec doesn't define any special parsing or detecCliente UI
    ...
    /*jshint evil:true */
      ...
      var saveClones = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|Cliente|tbody|td|th|tr|ul)$/i;
